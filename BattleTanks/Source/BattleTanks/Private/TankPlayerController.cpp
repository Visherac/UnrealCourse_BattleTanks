...
void ATankPlayerController::SetPawn(APawn * NewPawn)
{
	...
	if (NewPawn)
	{
		...
		if (ensure(TankPawn))
		{
			TankPawn->OnDeath.AddUniqueDynamic(this, &ATankPlayerController::HandleTankDeath);
		}
	}
}


void ATankPlayerController::HandleTankDeath()
{
	StartSpectatingOnly();
}
